...
resto vai para Outros, que abre a lista do que foi somado. Se você trocar, a sua escolha fica
guardada no seu navegador; sem trocar, vale o jeito que a equipe arrumou.
![](1.3/pizza.jpg)

## melhorou · Clicou, filtrou. Clicou de novo, desfez
Clicar em qualquer pedaço da tela filtra a tela toda: uma barra ou fatia (um cliente, um produto,
uma etapa), uma coluna do gráfico do tempo (uma hora, uma faixa de idade, um dia, um mês) ou um dos
números de cima (vencidos, parados, sem responsável, fechados). O gráfico onde você clicou continua
inteiro, com o escolhido em destaque: clique de novo nele para desfazer, ou em outro para trocar.
Ctrl+clique soma mais de um. Os filtros aparecem escritos logo abaixo, cada um com o seu X.
![](1.3/filtrado.jpg)

## novo · A administração arruma a tela para a equipe toda
Quem é da administração tem o botão Organizar: arraste cada gráfico pela alça para trocar de lugar
(ou use as setas), deixe na linha inteira ou em metade, esconda o que a equipe não usa e escolha se
abre em barras ou pizza. Em Salvar para todos, todo mundo passa a ver a tela assim. Os números de
cima e a tabela ficam fixos, e Voltar ao padrão desfaz a arrumação.
![](1.3/organizar.jpg)
...
12 meses. Clicar num dia filtra a tela por ele. Períodos longos passam a somar por mês. Também dá
para procurar pelo código do card ou por uma palavra, e incluir os arquivados (o Grafana não contava).
![](1.3/periodo.jpg)
