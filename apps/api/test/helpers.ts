...
export async function resetDb(app: App) {
  await app.db.execute(sql`
    TRUNCATE TABLE linechat_card_moves, linechat_cards, linechat_sync_runs, linechat_steps, linechat_fields, linechat_tags, audit_log, sessions, project_attachments, project_comments, project_checks, project_clients, project_steps, projects, release_note_reads, release_note_images, release_note_items, release_notes, device_movement_items, device_movements, devices, device_model_images, device_models, device_categories,
