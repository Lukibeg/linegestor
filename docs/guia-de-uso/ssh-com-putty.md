...
O botão SSH manda o Windows abrir um endereço `ssh://lucas@200.200.200.200:22`. Para o Windows saber que
isso é "coisa do PuTTY", basta dizer isso uma vez em cada computador.

> **O usuário é o seu, não o do cliente.** Cada técnico entra nos servidores com o próprio usuário, o
> mesmo em todos. Informe o seu em **Minha conta › Seu usuário SSH** — a partir daí, o botão já abre o
> PuTTY com ele. Sem usuário cadastrado, o PuTTY abre e pergunta.
...
**A senha vai junto?** Não. O atalho leva só usuário, endereço e porta. A senha do SSH é sua e não fica
no sistema — nunca em endereço de atalho, que ficaria gravado no histórico do navegador.
