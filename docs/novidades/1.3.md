...
Clicar em qualquer barra (um cliente, um produto, uma etapa, um responsável) filtra a tela toda
por ela. Os filtros aparecem escritos logo abaixo, cada um com o seu X, e os números obedecem a
