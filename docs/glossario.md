...
| **Link de terceiro** | Circuito que o próprio cliente contratou de outra operadora. Fica registrado, mas só aparece nas telas de Circuitos e no Painel quando se liga "Habilitar links de terceiros". Na ficha do cliente aparece sempre, com o chip *terceiro*. |
